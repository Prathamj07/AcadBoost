...
from pages.student.coding_background import show_coding_background
from pages.student.career_sathi import show_career_sathi
...
def main():
    ...
    elif st.session_state.page == "coding_background" and st.session_state.user["role"] == "student":
        show_coding_background()
    
    elif st.session_state.page == "career_sathi" and st.session_state.user["role"] == "student":
        show_career_sathi()
...
def show_teacher_navigation():
    ...
    options = {
        ...
        "Student Performance": show_student_performance,
