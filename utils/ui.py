...
def show_navigation(role):
    ...
    with st.sidebar:
        ...
        # if st.button("College Feed", use_container_width=True, key="common_feed"):
        ...
        if role == "admin":
            ...
            if st.button("Resume", use_container_width=True, key="student_resume"):
                ...
                st.rerun()
            if st.button("Coding Background", use_container_width=True, key="student_coding_background"):
                st.session_state.page = "coding_background"
                st.rerun()
            if st.button("Career Sathi", use_container_width=True, key="student_career_sathi"):
                st.session_state.page = "career_sathi"
                st.rerun()
