                    ...
                    if selected_cert:
                        ...
                        if selected_cert.get("verified", False):
                            ...
                            if st.button("Verify Certificate"):
                                ...
                                with st.form("verify_certificate_form"):
                                    verification_notes = st.text_area("Verification Notes", placeholder="Add any notes about the verification process...")
                                    submit_verification = st.form_submit_button("Submit Verification")
                                    
                                    if submit_verification:
                                        success, message = verify_certificate(
